...
function AboutAuthor() {
  ...
  return (
    <div className="mx-auto mb-5 mt-10 w-full px-4 md:max-w-screen-md">
      <div className="flex-1 px-2">
        <div className="flex flex-col flex-wrap items-start md:flex-nowrap">
          <h3 className="mb-4 w-full border-b border-slate-800 pb-2 text-base font-medium tracking-wider text-slate-400">
            Written by
          </h3>
